...
function Employee(name, email, hireDate) {
  ...
  */
  ...
  //will be an array of objects. These objects will each have 3 properties: id (a number), title (a string), 
  //and rating (a number between 1 and 5). These objects are the posts that the user will have saved to their 
  //account.
  
  // Once the User constructor function is created, write a prototype method for the User function. Name this 
  //method addSavedPost. It should take in three parameters: id (a number), title (a string) and
